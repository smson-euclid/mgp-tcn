...
DROP MATERIALIZED VIEW IF EXISTS control_55h_hourly_vitals_ex1c_new_extend CASCADE;
create materialized view control_55h_hourly_vitals_ex1c_new_extend as
...
FROM  (
  ...
  and ce.charttime between (ch.control_onset_time-interval '72' hour ) and (ch.control_onset_time+interval '7' hour ) 
