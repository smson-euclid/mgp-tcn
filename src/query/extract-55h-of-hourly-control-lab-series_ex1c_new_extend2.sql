...
DROP MATERIALIZED VIEW IF EXISTS control_55h_hourly_labs_ex1c_new_extend2 CASCADE;
CREATE materialized VIEW control_55h_hourly_labs_ex1c_new_extend2 AS
SELECT
  pvt.icustay_id
  , pvt.subject_id
  , pvt.chart_time
...
( -- begin query that extracts the data
  ...
  from matched_controls_hourly ch
    ...
    LEFT JOIN labevents le
      ...
      AND le.charttime BETWEEN (ch.control_onset_time - interval '96' hour) AND (ch.control_onset_time+interval '7' hour)
      AND le.ITEMID in
    (
