...
DROP MATERIALIZED VIEW IF EXISTS case_55h_hourly_vitals_ex1c_new_extend CASCADE;
create materialized view case_55h_hourly_vitals_ex1c_new_extend as
...
FROM  (
  ...
  and ce.charttime between (ch.sepsis_onset-interval '72' hour ) and (ch.sepsis_onset+interval '7' hour ) 
